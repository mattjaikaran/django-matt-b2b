"""
Django settings for django-matt-b2b project.

B2B multi-tenant API built with django-matt framework.
...
MIDDLEWARE = [
    ...
    # Tenant context middleware (uncomment to enable)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "django_matt_b2b"),
